const RESOURCES_DIS = {
    ...
    inf: {
        ...
        desc: (gs)=>player.inf.points.format(0)+"<br>（+"+tmp.IP_gain.format(0)+"）"+"<br>（到無限："+formatPercent(player.mass.max(1).log10().max(1).log10().div(tmp.inf_limit.max(1).log10().max(10).log10()).max(0).min(1))+"）",
